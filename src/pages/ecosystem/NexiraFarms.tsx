        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-7">
              ...
              >
                An agribusiness developing productive, sustainable farmland that strengthens food security,
                creates rural employment, and supplies local and regional markets.
              </p>
            </div>
              ...
              <div className="rounded-xl3 border border-navy/10 bg-white p-8 shadow-float">
                ...
                <dl className="mt-5 space-y-5">
                  <div>
                    ...
                    <dd className="mt-1 text-lg font-medium text-navy">Agriculture and Agri-Business</dd>
                  </div>
                  <div>
