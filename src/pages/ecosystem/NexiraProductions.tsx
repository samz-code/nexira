...
const STRENGTHS = [
  ...
  'Pan-African distribution reach',
];

export function NexiraProductions() {
  useEffect(() => {
  ...
  return (
    <article className="bg-cream">
      ...
      <header className="relative min-h-[62vh] overflow-hidden bg-navy text-cream">
        <motion.img
          src={IMAGES.ecosystem.productionsA}
          alt="Nexira Productions"
        ...
        <Container className="relative z-10 flex min-h-[62vh] flex-col justify-end pb-14 pt-32">
          ...
          <div className="mt-6">
            ...
            >
              Film, Broadcast and Visual Storytelling
            </span>
          </div>
        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-7">
              ...
              >
                A full-service production house creating documentaries, branded films, and broadcast content
                that captures the spirit of South Sudan and the wider region, for audiences at home and abroad.
              </p>
            </div>
              ...
              <div className="rounded-xl3 border border-navy/10 bg-white p-8 shadow-float">
                ...
                <dl className="mt-5 space-y-5">
                  <div>
                    ...
                    <dd className="mt-1 text-lg font-medium text-navy">Film, Broadcast and Visual Storytelling</dd>
                  </div>
                  <div>
