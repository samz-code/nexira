...
const SERVICES = [
  ...
  'Digital publishing',
  'Brand and corporate media',
  'Audience strategy',
];
const STRENGTHS = [
  'Independent editorial standards',
  'Multi-platform distribution',
  'Trusted regional network',
];

export function NexiraMedia() {
  useEffect(() => {
      ...
      <header className="relative min-h-[62vh] overflow-hidden bg-navy text-cream">
        ...
        <Container className="relative z-10 flex min-h-[62vh] flex-col justify-end pb-14 pt-32">
          ...
          <p className="mt-4 max-w-2xl text-xl font-medium italic text-gold sm:text-2xl">
            A voice for what is being built.
          </p>
        </Container>
      </header>
        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-7">
              ...
              >
                A modern media platform producing journalism, analysis, and digital content that elevates
                underrepresented stories and builds an informed public across South Sudan.
              </p>
            </div>
              ...
              <div className="rounded-xl3 border border-navy/10 bg-white p-8 shadow-float">
                ...
                <dl className="mt-5 space-y-5">
                  <div>
                    ...
                    <dd className="mt-1 text-lg font-medium text-navy">Media, Publishing and Digital Content</dd>
                  </div>
                  <div>
